 ...
 */
package se.inera.intyg.certificateprintservice.application.print.converter.custom;
...
public class CustomPdfRequestConverter {
  ...
  private CustomPdfFieldF convertField(CustomPdfFieldDTO dto) {
    return CustomPdfFieldF.builder().value(dto.getValue()).build();
  }
}
